    ...
    <nav>
      <div className="flex justify-between items-center p-4">
        ...
        <div className={`lg:flex lg:items-center ${isOpen ? "block" : "hidden"}`}>
          <a href="https://drive.google.com/file/d/1573LZUWGLC3yE48K2POI9Q3I22ue9jiP/view?usp=drive_link" target="_blank" className="block mt-4 lg:inline-block lg:mt-0 hover:text-black text-[#555] mr-10">Resume</a>
